...
function create() {
    ...
    scoreText = game.add.text(16, 16, '$$DIAMONDS$$: 0', {
        fontSize: '32px',
        fill: '#000'
    });
    ...
    score2Text = game.add.text(450, 16, '$$DIAMONDS$$: 0', {
        fontSize: '32px',
        fill: '#000'
    });
    ...
    livesText = game.add.text(16, 40, 'Lives: 3', {
        fontSize: '32px',
        fill: '#000'
    });
    ...
    liveText = game.add.text(450, 40, 'Lives: 3', {
        fontSize: '32px',
        fill: '#000'
    });
    ...
    byJoey = game.add.text(300, 250, 'Diamond Run', {
        fontSize: '50px',
        fill: '#000'
    });
